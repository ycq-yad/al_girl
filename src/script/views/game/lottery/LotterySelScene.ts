...
export class LotterySelScene extends BaseSceneUISkin {
    ...
    private async  getLotteryConfig() {
        return new Promise((resolve) => {
            Laya.loader.load("resource/assets/config/LotteryConfig.json" + Als_GameData.getInstance().randomTime, Laya.Handler.create(this, async (data) => {
    ...
    public checkCanFreeLottery() {
        ...
        if (Utils.judgeIsOnTheSameDay(PlayerDataManager_Als.getInstance().stPlayerDataBase.nLotteryTimeLast, nCurTime)) {//显示
