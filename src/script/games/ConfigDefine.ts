//签到数据定义
export type Als_ConfigSignDataIndex = {
    ID:number;          //编号
...
//GameConfig中的通用配置
export type Als_GameConfigIndex = {
    ID:number;          //数据编号
...
//LevelPs中的配置数据
export type Als_LevelPsIndex = {
    ID:number;
    nPs:number;
}

//DialogBox中的配置参数
export type Als_DialogBoxIndex = {
    id:number;
    type:number;
    desc:string;
    showid:string;
...
//邀请表
export type Als_InviteConfigIndex = {
    ID:number;          //编号
