 ...
 * GamePreLoadingView
 */
export default class GamePreLoadingView_Als extends BaseSceneUISkin implements ILoadingView {
    ...
    constructor() {
        ...
        if (DeviceUtil.isWXMiniGame()) {
            this.img_head.skin = "resource/assets/preloading/loading_logo_6_6.png";
        } else {
